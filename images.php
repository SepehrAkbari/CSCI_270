...
<style type="text/css">
    ...
    ***********************************************************************/
    #bg_repeat_both {
    background-image: url("images/pics/pattern2.jpg"); 
    ...
    background-image: url("images/pics/pattern2.jpg"), url("images/pics/pattern2.jpg");
...
<div id="hw_wrapper">
    ...
    <br><br>
    <img src="images/pics/pattern1.jpg">
    <br><br>

    Put the graphic after one Flip (reflection) here:
    <br><br>
    <img style="transform: scaleX(-1);" src="images/pics/pattern1.jpg">
    <br><br>

    Put the final graphic here (non-tiled of course):
    <br><br>
    <img src="images/pics/pattern2.jpg">
    <br><br>
